...
?>
<h4><b><?php _e('BuddyPress Groups', DW_L10N_DOMAIN); ?></b><?php echo ( count($opt_bp_group) > 0 ? ' <img src="' . $DW->plugin_url . 'img/checkmark.gif" alt="Checkmark" />' : '' ); ?></h4>
<div class="dynwid_conf">
...
<tr>
  ...
  <td valign="top">
		...
		<input type="checkbox" id="bp_group_act_<?php echo $id; ?>" name="bp_group_act[]" value="<?php echo $id; ?>" <?php echo ( count($bp_group_act) > 0 && in_array($id, $bp_group_act) ) ? 'checked="checked"' : ''; ?> /> <label for="bp_group_act_<?php echo $id; ?>"><?php echo $group_pages; ?></label><br />
		<?php	 } ?>
		</div>
  </td>
</tr>
