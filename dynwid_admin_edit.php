 ...
 */
	...
	// BP Plugin support (http://buddypress.org/)
  ...
  if ( $DW->bp ) {
  	...
  	$bp_components = dw_get_components();
...
<!-- Attachment //-->
<h4><b><?php _e('Attachments', DW_L10N_DOMAIN); ?></b><?php echo ( count($opt_attachment) > 0 ? ' <span class="hasoptions">*</span>' : '' ); ?></h4>
<div class="dynwid_conf">
